...
console.log(quickSort(nums1))// [2, 3, 6, 7, 8, 11, 14]
console.log(quickSort(nums2)) // [1, 3, 4, 9, 12, 13, 17, 21, 27]
console.log(quickSort(nums3)) // [2, 3, 3, 3, 6, 7, 8, 11, 14]
console.log(quickSort(nums4)) // [1, 3, 4, 9, 12, 13, 17, 21, 27]
console.log(quickSort(testArr)) // [1, 3, 4, 9, 12, 13, 17, 21, 27]
